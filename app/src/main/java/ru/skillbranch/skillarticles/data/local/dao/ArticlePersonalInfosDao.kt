...
interface ArticlePersonalInfosDao: BaseDao<ArticlePersonalInfo> {
    ...
    @Query("""
        UPDATE article_personal_infos SET is_like = NOT is_like
    ...
    suspend fun toggleBookmarkOrInsert(articleId: String): Boolean{
        ...
        return isBookmarked(articleId)?:false
    }
...
//        WHERE article_id = :articleId
//    """)
//    suspend fun findPersonalInfos(articleId: String): LiveData<ArticlePersonalInfo>

//    @Query("""
//        SELECT * FROM article_personal_infos
//    """)
//    suspend fun findPersonalInfos(): LiveData<List<ArticlePersonalInfo>>
